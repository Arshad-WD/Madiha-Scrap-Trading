        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a href="tel:+918291312907" aria-label="Call Us" className="w-10 h-10 flex items-center justify-center border border-gray-200 rounded text-gray-600 hover:bg-gray-50 hover:text-amber-700 transition-colors">
              ...
              <a href="https://wa.me/918291312907" aria-label="WhatsApp Us" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-gray-200 rounded text-gray-600 hover:bg-green-50 hover:text-green-600 transition-colors">
