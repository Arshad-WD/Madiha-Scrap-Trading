...
export default function ProcessSection() {
  return (
    <section id="process" className="section-wrapper bg-primary relative overflow-hidden">
      <div className="section-container">
              ...
              <div key={i} className={`relative lg:flex items-center gap-12 lg:gap-0 ${i % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"}`}>
                ...
                <div className="lg:w-1/2">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className={`glass-card p-6 md:p-10 lg:p-12 relative ${i % 2 === 0 ? "lg:mr-12" : "lg:ml-12"}`}
                  >
                    <div className="absolute top-0 right-0 p-4 text-white/5 font-black text-6xl leading-none italic select-none">
                      0{i + 1}
                    </div>
                    <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center text-accent mb-6">
                      {step.icon}
                    </div>
                    <h3 className="text-2xl font-black text-white mb-4 italic tracking-tight">{step.title}</h3>
                ...
                <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 hidden lg:flex items-center justify-center">
                  <div className="w-10 h-10 rounded-full bg-primary border-4 border-accent shadow-[0_0_20px_rgba(152,193,217,0.3)] z-10" />
                </div>
        ...
        <div className="absolute left-8 top-[20%] bottom-[10%] w-px bg-white/5 lg:hidden" />
      </div>
    </section>
  );
}
