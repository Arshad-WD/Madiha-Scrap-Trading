      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 w-full py-12 lg:py-0">
        <div className="max-w-3xl">
          <div className="flex items-center gap-3 mb-6">
            <span className="inline-block h-1 w-12" style={{ background: "var(--accent)" }} />
            <span className="text-sm font-bold uppercase tracking-widest" style={{ color: "var(--accent)" }}>Mumbai's Trusted Scrap Dealer</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold uppercase leading-tight mb-6" style={{ color: "var(--text-primary)" }}>
            WE BUY <br/>
            <span style={{ color: "var(--accent)" }}>& SELL</span><br/>
            ALL SCRAP
          </h1>
          
          <p className="text-lg md:text-xl mb-8 max-w-2xl text-gray-600">
            Get the best market value for your commercial and industrial scrap. We offer honest weighing, instant payment, and free doorstep pickup across Mumbai.
          </p>
